jsPsych.plugins["MSIT-demand-selection"] = (function() {
    ...
    plugin.info = {
      ...
      parameters: {
        ...
        n_repeats: {
          type: jsPsych.plugins.parameterType.INT,
          default: undefined,
          description: 'number of times to repeat the set of demand selection tasks',
        }
      }
    }
    ...
    plugin.trial = function(display_element, trial) {
      ...
      var n_repeats_demand_selection = trial.n_repeats; // # of times to repeat set of demand selection choices
      ...
      var demand_selection_sequence = async function(){
        for (var i = 0; i < n_repeats_demand_selection; i++) {
          ...
          // order of screen sides -- shuffle again
          left_or_right = jsPsych.randomization.shuffle(left_or_right); 
  
          // reset # distinct trials performed 
          dst_index = 0;
